...
// Constructor
RequestParser::RequestParser(const std::string &request, ServerConfig *v_server)
{
...
void RequestParser::match_location(const std::string &uri, const std::vector<ServerConfig> &servers)
{
	(void)uri;
	(void)servers;
}
